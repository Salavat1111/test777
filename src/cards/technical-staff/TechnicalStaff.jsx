...
function TechnicalStaff({ }) {
    const ItemsText = [
        ...
        },
        {
            ...
            icon: <FaAngleDown />,
            description: 'Начать работу техников с сервисом ТВОЙ ТЕХНИК очень просто.'
        },
        {
            text: 'Если нет опыта, можно у Вас работать?',
            icon: <FaAngleDown />,
            description: 'Выполнять заказы могут техники старше 21 года, со стажем от трёх лет и водительским удостоверением, выданным в РФ, Беларуси, Кыргызстане, Казахстане, Абхазии и Южной Осетии. Новичкам мы расскажем обо всех особенностях и стандартах качества нашего сервиса.'
        },
    ];
